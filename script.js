...
function drawText() {
  ...
  if (frameNumber < 300) {
    ...
    context.fillText(
      "Oh, my dearest [name], soft and bright,Even fever can’t dim your light.",
      canvas.width / 2,
      canvas.height / 2
    );
  ...
  if (frameNumber > 600 && frameNumber < 900) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        ["Rest up, my love, feel warm and free,Under the moon, just you and me."],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
        lineHeight
  ...
  if (frameNumber > 1200 && frameNumber < 1500) {
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
    context.fillText(
      "When you're better, no words to say,I’ll take your hand and lead the way.",
      canvas.width / 2,
      canvas.height / 2
    );
    opacity = opacity + 0.01;
  ...
  if (frameNumber > 1800 && frameNumber < 2100) {
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
    context.fillText(
      "A gentle dance, a touch so true,In moonlit magic, just us two.",
      canvas.width / 2,
      canvas.height / 2
    );
    opacity = opacity + 0.01;
  ...
  if (frameNumber > 2400 && frameNumber < 2700) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          "Through whispered winds and starlit streams,",
          "I'll hold you close in all your dreams.",
        ],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
      ...
      context.fillText(
        "Through whispered winds and starlit streams, I'll hold you close in all your dreams.",
        canvas.width / 2,
        canvas.height / 2
      );
    }
  ...
  if (frameNumber > 3000 && frameNumber < 99999) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          "When dawn’s embrace melts night away,",
          "I’ll be right here, forever to stay.",
        ],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
      ...
      context.fillText(
        "When dawn’s embrace melts night away,I’ll be right here, forever to stay.",
        canvas.width / 2,
        canvas.height / 2
      );
    }
